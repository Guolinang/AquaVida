...
Q_CONSTINIT static const qt_meta_stringdata_Filter_t qt_meta_stringdata_Filter = {
    {
        ...
        QT_MOC_LITERAL(7, 7),  // "filterA"
        QT_MOC_LITERAL(15, 0),  // ""
        QT_MOC_LITERAL(16, 16),  // "QList<QVariant>*"
        QT_MOC_LITERAL(33, 4),  // "list"
        QT_MOC_LITERAL(38, 7),  // "createA"
        QT_MOC_LITERAL(46, 20),  // "on_Button_CF_clicked"
        QT_MOC_LITERAL(67, 24)   // "on_Button_Cancel_clicked"
    },
    "Filter",
    "filterA",
    "",
...
void Filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->filterA((*reinterpret_cast< std::add_pointer_t<QList<QVariant>*>>(_a[1]))); break;
        case 1: _t->createA((*reinterpret_cast< std::add_pointer_t<QList<QVariant>*>>(_a[1]))); break;
        case 2: _t->on_Button_CF_clicked(); break;
        ...
        {
            using _t = void (Filter::*)(QList<QVariant> * );
            if (_t _q_method = &Filter::filterA; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Filter::*)(QList<QVariant> * );
            if (_t _q_method = &Filter::createA; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Filter::filterA(QList<QVariant> * _t1)
{
...
// SIGNAL 1
void Filter::createA(QList<QVariant> * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
